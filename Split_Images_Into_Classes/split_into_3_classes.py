# -*- coding: utf-8 -*-
"""
Created on Mon Jul 17 11:19:56 2023
...
list_images = os.listdir('C:/AHI Data/Front_Images')
...
y_1 = (np.percentile(list_incomes_norm,33))
y_2 = (np.percentile(list_incomes_norm,66))
...
li = [li_0, li_1, li_2]
print ('Sum of lengths: ', len(li_0)+len(li_1)+len(li_2), len(list_incomes_norm))
...
for i in range(3):
    ...
    for x in tqdm(train[i]):
        filename = x[0]
        old_file = 'C:/AHI Data/Front_Images/' + filename + '_HouseFront_2.jpg'
        new_fold = 'C:/AHI Data/Front_Images/train/class'+str(i)+'/'
        try:
    ...
    for x in tqdm(test[i]):
        filename = x[0]
        old_file = 'C:/AHI Data/Front_Images/' + filename + '_HouseFront_2.jpg'
        new_fold = 'C:/AHI Data/Front_Images/test/class'+str(i)
        try:
            os.makedirs(new_fold)
        except:
            pass
    ...
    for x in tqdm(valid[i]):
        filename = x[0]
        old_file = 'C:/AHI Data/Front_Images/' + filename + '_HouseFront_2.jpg'
        new_fold = 'C:/AHI Data/Front_Images/valid/class'+str(i)
        try:
            os.makedirs(new_fold)
        except:
            pass
