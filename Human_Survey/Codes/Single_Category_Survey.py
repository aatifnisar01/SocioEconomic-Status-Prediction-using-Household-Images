...
class ImageLabelApp:
    def __init__(self, root, image_folder):
        ...
        self.class_options = ["low income", "lower middle income", "middle income", "higher middle income", "high income"]
        self.class_buttons = []
...
if __name__ == "__main__":
    ...
    image_folder = "D:/train"  # Replace this with the path to your 'interior' folder
